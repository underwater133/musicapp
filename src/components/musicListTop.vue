<template>
  <div class="musicListTop" v-if="topInfo.data">
    ...
    <div class="tab">
      <div class="left">
        <svg @click="router.back()" t="1646914191117" class="icon" viewBox="0 0 1024 1024" version="1.1"
          xmlns="http://www.w3.org/2000/svg" p-id="2043" width="48" height="48">
          <path
            ...
            p-id="2044" fill="#ffffff"></path>
        </svg>
        <span>歌单</span>
      </div>
      <div class="right">
        <svg t="1646914280379" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="3185" width="48" height="48">
          <path
            ...
            p-id="3186" fill="#ffffff"></path>
        </svg>
        <svg t="1646914337427" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="6162" width="48" height="48">
          <path
            d="M512 213.333333m-106.666667 0a106.666667 106.666667 0 1 0 213.333334 0 106.666667 106.666667 0 1 0-213.333334 0Z"
            p-id="6163" fill="#ffffff"></path>
          <path
            d="M512 512m-106.666667 0a106.666667 106.666667 0 1 0 213.333334 0 106.666667 106.666667 0 1 0-213.333334 0Z"
            p-id="6164" fill="#ffffff"></path>
          <path
            d="M512 810.666667m-106.666667 0a106.666667 106.666667 0 1 0 213.333334 0 106.666667 106.666667 0 1 0-213.333334 0Z"
    ...
    <div class="detail">
      ...
      <div class="textInfo" v-if="topInfo.data.name">
        ...
        <div class="creator">
          ...
          <svg t="1646970656124" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="16983" width="16" height="16">
            <path
              ...
              p-id="16984" fill="#e6e6e6"></path>
          </svg>
        </div>
        <div class="desc">
          <span v-if="topInfo.data.description">{{ topInfo.data.description }}</span>
          <span v-else>暂无简介</span>
          <svg v-if="topInfo.data.description" t="1646970656124" class="icon" viewBox="0 0 1024 1024" version="1.1"
            xmlns="http://www.w3.org/2000/svg" p-id="16983" width="16" height="16">
            <path
              d="M761.6 489.6l-432-435.2c-9.6-9.6-25.6-9.6-35.2 0-9.6 9.6-9.6 25.6 0 35.2l416 416-416 425.6c-9.6 9.6-9.6 25.6 0 35.2s25.6 9.6 35.2 0l432-441.6C771.2 515.2 771.2 499.2 761.6 489.6z"
              p-id="16984" fill="#e6e6e6"></path>
          </svg>
    ...
    <!-- 评论收藏下载多选 -->
    <div class="options">
      <div class="item" @click="toComments()">
        <svg t="1647009893456" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="2377" width="48" height="48">
          <path
          ...
          <path
            ...
            p-id="2379" fill="#E9E9E9"></path>
        </svg>
        <span>{{ formatCount(topInfo.data.commentCount) }}</span>
      </div>
      <div class="item">
        <svg t="1647013660915" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="1275" width="48" height="48">
          <path
            ...
            p-id="1276" fill="#E9E9E9"></path>
        </svg>
        <span>{{ formatCount(topInfo.data.shareCount) }}</span>
      </div>
      <div class="item">
        <svg t="1647016514382" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="1466" width="48" height="48">
          <path
            d="M512 1024C229.239467 1024 0 794.760533 0 512 0 229.239467 229.239467 0 512 0a30.1056 30.1056 0 1 1 0 60.245333 451.754667 451.754667 0 1 0 268.1856 88.234667 30.139733 30.139733 0 0 1 35.84-48.469333A512 512 0 0 1 512 1024z"
            p-id="1467" fill="#E9E9E9"></path>
          <path
            d="M512 587.298133a30.1056 30.1056 0 0 1-30.1056-30.1056V30.1056a30.1056 30.1056 0 1 1 60.2112 0v527.086933a30.1056 30.1056 0 0 1-30.1056 30.1056z"
            p-id="1468" fill="#E9E9E9"></path>
          <path
            d="M512 609.723733a30.1056 30.1056 0 0 1-21.230933-8.874666l-127.863467-127.863467a30.1056 30.1056 0 0 1 42.632533-42.461867L512 537.019733l106.496-106.496a30.1056 30.1056 0 0 1 42.5984 42.461867l-127.863467 127.863467a30.1056 30.1056 0 0 1-21.230933 8.874666z"
            p-id="1469" fill="#E9E9E9"></path>
        </svg>
        <span>下载</span>
      </div>
      <div class="item">
        <svg t="1647016536832" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
          p-id="1659" width="48" height="48">
          <path
            d="M512 996C244.694 996 28 779.306 28 512 28 244.694 244.694 28 512 28c267.306 0 484 216.694 484 484 0 267.306-216.694 484-484 484z m0-72c227.541 0 412-184.459 412-412S739.541 100 512 100 100 284.459 100 512s184.459 412 412 412z m-84.295-291.711L740.75 301.336c11.692-12.361 30.744-12.46 42.553-0.22l0.21 0.22 27.31 28.871c2.903 3.069 2.903 8.013 0 11.081L449.139 723.664c-11.693 12.361-30.745 12.46-42.553 0.22l-0.212-0.22-25.805-27.283-0.051 0.056-167.34-176.914c-2.904-3.069-2.904-8.012 0-11.081l27.309-28.872c11.692-12.36 30.744-12.46 42.552-0.22l0.21 0.22 144.456 152.72v-0.001z"
            p-id="1660" fill="#E9E9E9"></path>
        </svg>
        <span>多选</span>
      </div>
    </div>
...
export default {
  ...
  setup(props) {
    ...
    return {
      formatCount, router, toComments, commentInfo
    }
  }
}
</script>
